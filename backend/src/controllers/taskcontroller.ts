...
export const createTask = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  ...
  const newTask = await TaskModel.create({
    ...
    description,
    dueDate,
    createdBy: (req.user as IUser)._id, // Ensure AuthAuthRequest type is set in middleware
  });
 ...
 */
export const assignTask = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  const { id } = req.params;
 ...
 */
export const submitTask = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
 ...
 */
export const reviewTask = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
